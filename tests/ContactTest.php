...
class ContactTest extends BaseTest
{
	...
	*/
	public function testContactList()
	{
		...
		$this->assertInstanceOf('Bkd27\\SurveyMonkey\\Response', $contactListsResponse);
		...
		$this->assertInstanceOf('Bkd27\\SurveyMonkey\\Response', $createContactListResponse);
	...
	*/
	public function testContact()
	{
		...
		$this->assertInstanceOf('Bkd27\\SurveyMonkey\\Response', $contactsResponse);
